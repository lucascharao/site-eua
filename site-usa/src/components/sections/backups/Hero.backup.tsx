...
export function Hero() {
  ...
  return (
    ...
    >
        ...
        >
          <div className="relative w-36 h-36 md:w-48 md:h-48">
            ...
            <motion.div
              animate={{
                boxShadow: [
                  "0 0 30px 10px rgba(197,165,90,0.15)",
                  "0 0 60px 20px rgba(197,165,90,0.3)",
                  "0 0 30px 10px rgba(197,165,90,0.15)",
                ],
              }}
      ...
      {/* 3D floating bathroom images on sides */}
      <motion.div
        style={{ x: parallaxX, y: parallaxY }}
      ...
      >
        <motion.div
          ...
          className="absolute left-[2%] top-[15%] w-[280px] h-[400px] rounded-2xl overflow-hidden border border-gold/10"
          style={{ transform: "perspective(800px) rotateY(18deg)", transformStyle: "preserve-3d" }}
        >
          <Image src="/images/bathrooms/bathroom-1.webp" alt="Luxury master bathroom with freestanding tub" fill className="object-cover" sizes="280px" />
        ...
        <motion.div
          ...
          className="absolute right-[2%] top-[18%] w-[270px] h-[390px] rounded-2xl overflow-hidden border border-gold/10"
          style={{ transform: "perspective(800px) rotateY(-18deg)", transformStyle: "preserve-3d" }}
        >
          <Image src="/images/bathrooms/bathroom-4.webp" alt="Elegant bathroom with gold fixtures" fill className="object-cover" sizes="270px" />
